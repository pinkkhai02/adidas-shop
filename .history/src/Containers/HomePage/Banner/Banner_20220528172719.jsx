      ...
      <div className="component-waper">
          <div className="wapper-banner">
            <div className="player">
              <video src="https://brand.assets.adidas.com/video/upload/q_auto,vc_auto/video/upload/sustainability-ss22-rfto-launch-hp-mh-d_qec44x.mp4" autoPlay loop></video>
            </div>
          </div>
