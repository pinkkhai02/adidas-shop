      ...
      <div className="component-waper">
          <div className="wapper-banner">
            <div  style={{width: "100%", height:"100%" }} className="player">
              <video src="https://brand.assets.adidas.com/video/upload/q_auto,vc_auto/video/upload/sustainability-ss22-rfto-launch-glpf-mh-d_lvqath.mp4" preload='auto' autoPlay loop playsInline  style={{width: "100%", height:"100%" }} > 
              </video>
            </div>
          </div>
      ...
      <div className="component-waper ">
          ...
          <div className="content-left">
            <div className="poster-content">
              ...
              <div className="button">
                <div className="button-item">
                  <a href="#" className="button-item__link">Mua ngay</a>
                  <i className="fa-solid fa-arrow-right"></i>
                </div>
              </div>
            </div>
