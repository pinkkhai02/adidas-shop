    ...
    <section className="banner">
      ...
      <div className="component-waper">
          <div className="wapper-banner">
            <div  style={{width: "100%", height:"100%" }} className="player">
              <picture>
                <source srcset="https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_1920,w_1920/viVN/Images/football-fw22-arsenal-home-hp-mh-02-new-d_tcm337-885877.jpg">
                </source> 
              </picture>
            </div>
          </div>
