      ...
      <div className="component-waper">
          <div className="wapper-banner">
            <div className="player">
              <video src="https://brand.assets.adidas.com/video/upload/q_auto,vc_auto/video/upload/sustainability-ss22-rfto-launch-glpf-mh-d_lvqath.mp4" preload='auto' autoPlay loop    style={{width: "100%", height:"100%" }} > 
              </video>
            </div>
          </div>
